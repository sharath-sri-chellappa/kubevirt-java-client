...
public class V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference {
  ...
  public V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference matchExpressions(List<V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreferenceMatchExpressions> matchExpressions) {
    
    this.matchExpressions = matchExpressions;
    return this;
  }

  public V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference addMatchExpressionsItem(V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreferenceMatchExpressions matchExpressionsItem) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference matchFields(List<V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreferenceMatchExpressions> matchFields) {
    
    this.matchFields = matchFields;
    return this;
  }

  public V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference addMatchFieldsItem(V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreferenceMatchExpressions matchFieldsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference v1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference = (V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference) o;
    return Objects.equals(this.matchExpressions, v1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference.matchExpressions) &&
        Objects.equals(this.matchFields, v1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference.matchFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha3VirtualMachineInstanceSpecAffinityNodeAffinityPreference {\n");
