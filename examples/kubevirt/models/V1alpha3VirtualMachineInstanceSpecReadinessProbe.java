 ...
 */
@ApiModel(description = "Periodic probe of VirtualMachineInstance service readiness. VirtualmachineInstances will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes")
...
public class V1alpha3VirtualMachineInstanceSpecReadinessProbe {
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe failureThreshold(Integer failureThreshold) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe httpGet(V1alpha3VirtualMachineInstanceSpecLivenessProbeHttpGet httpGet) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe initialDelaySeconds(Integer initialDelaySeconds) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe periodSeconds(Integer periodSeconds) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe successThreshold(Integer successThreshold) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe tcpSocket(V1alpha3VirtualMachineInstanceSpecLivenessProbeTcpSocket tcpSocket) {
  ...
  **/
  ...
  public V1alpha3VirtualMachineInstanceSpecReadinessProbe timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3VirtualMachineInstanceSpecReadinessProbe v1alpha3VirtualMachineInstanceSpecReadinessProbe = (V1alpha3VirtualMachineInstanceSpecReadinessProbe) o;
    return Objects.equals(this.failureThreshold, v1alpha3VirtualMachineInstanceSpecReadinessProbe.failureThreshold) &&
        Objects.equals(this.httpGet, v1alpha3VirtualMachineInstanceSpecReadinessProbe.httpGet) &&
        Objects.equals(this.initialDelaySeconds, v1alpha3VirtualMachineInstanceSpecReadinessProbe.initialDelaySeconds) &&
        Objects.equals(this.periodSeconds, v1alpha3VirtualMachineInstanceSpecReadinessProbe.periodSeconds) &&
        Objects.equals(this.successThreshold, v1alpha3VirtualMachineInstanceSpecReadinessProbe.successThreshold) &&
        Objects.equals(this.tcpSocket, v1alpha3VirtualMachineInstanceSpecReadinessProbe.tcpSocket) &&
        Objects.equals(this.timeoutSeconds, v1alpha3VirtualMachineInstanceSpecReadinessProbe.timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha3VirtualMachineInstanceSpecReadinessProbe {\n");
